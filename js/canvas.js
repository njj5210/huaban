$(function(){
    ...
    $("nav ul li").click(function(){
        ...
        $("nav ul li").css({background:"#666",color:"#fff"}).eq(index).css({background:"#ccc",color:"#666"});
        $("nav ul li").css({color:"#fff"}).eq(index).css({color:"#fff"}).css("text-shadow","none");
    ...
    wenjian.click(function(){
        ...
        wenjian.css({color:"#fff"}).css("text-shadow","none");
        wenjian.eq(index).css({color:"#fff"}).css("text-shadow","0 0 0 ");
        //新建
        if(index==0){
    ...
    xingzhuang.click(function(){
        ...
        xingzhuang.eq(index).css({color:"#fff"}).css("text-shadow","0 0 0 ");
    })
    ...
    leixing.click(function(){
        ...
        leixing.eq(index).css({color:"#fff"}).css("text-shadow","0 0 0 ");
    })
    //绘图颜色
    //1.边框颜色
    ...
    xk.click(function(){
        ...
        xk.eq(index).css({color:"#fff"}).css("text-shadow","none");
    })
    //橡皮擦
    ...
    xp.click(function(){
        ...
        xp.eq(index).css({color:"#fff"}).css("text-shadow","none");
    })
    //选择
    $(".select").click(function(){
        newobj.select($(".selectarea"));
        $(".select").css({color:"#fff"}).css("text-shadow","none");
